/*WPSOL_MINIFIED_JS*/new Vue({el:"#user-plan-detail",data:{message:null,cancel_url:null,user_id:null,user_plan_id:null,loading:false},created(){if(typeof user_plan_detail_data=="undefined")
